...
import 'package:locked_in/presentation/dispatchers_list/controllers/dispatchers_list_controller.dart';
import 'package:locked_in/data/models/dispatcher.dart';
  ...
  Future<String> _getParticipantName(int participantId) async {
    ...
    try {
      if (Get.isRegistered<DispatchersListController>()) {
        ...
        // final dispatcher = dispatchersController.dispatchers;
