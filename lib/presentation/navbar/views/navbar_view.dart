  ...
  Widget build(BuildContext context) {
    return GetBuilder<NavbarController>(builder: (_) {
      return WillPopScope(
        ...
        child: BackgroundSimpleWidget(child: 
        Scaffold(
            ...
            bottomNavigationBar: BottomNavigationBar(
                  ...
                  items: <BottomNavigationBarItem>[
                    BottomNavigationBarItem(
                      icon: GestureDetector(
                        ...
                        child: ImageIcon(
                          AssetImage(Utils.getIconPath(
                              controller.selectedIndex.value == 0 ? "home_fill" : "home")),
                          size: 40,
                        ),
                      ),
                      label: 'Home'.tr,
                    ...
                    BottomNavigationBarItem(
                      icon: ImageIcon(
                        AssetImage(Utils.getIconPath("tools_fill")),
                        size: 40,
                      ),
                      label: 'Orders'.tr,
                    ),
                    BottomNavigationBarItem(
                      icon: ImageIcon(
                        AssetImage(Utils.getIconPath(
                            controller.selectedIndex.value == 2 ? "chat_fill" : "chat")),
                        size: 40,
                      ),
                      label: 'Chats'.tr,
                    ),
                    BottomNavigationBarItem(
                      icon: ImageIcon(
                        AssetImage(Utils.getIconPath(
                            controller.selectedIndex.value == 3 ? "profile_fill" : "profile")),
                        size: 40,
                      ),
                      label: 'Profile'.tr,
                    ),
                  ...
                  backgroundColor: AppColors.trans, // FIX: Ensures correct gradient background
